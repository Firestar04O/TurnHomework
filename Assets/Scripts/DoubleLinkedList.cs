...
public class DoubleLinkedList<T>
{
    ...
    public Node<T> Seek(T objective, Node<T> _head = null, int deep = 0)
    {
        ...
        {
            //No hay elementos en la lista o No se encontro elemento
            return null;
        }
        if (_head == null)
            _head = head;
        ...
        {
            //"Elemento encontrado: " + _head.Value.ToString()
            //"Se encontro en la posicion: " + deep
            return _head;
        }
        else
